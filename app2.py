        ...
        with st.chat_message("assistant"):
            if st.session_state.messages:
                ...
                if "high risk" in assistant_response:
                    st.write("Please go to [this link](https://3.106.58.71:8501) for the fall-related injury risk assessment.")
                else:
                    st.write("Please go to [this link](https://www.samitivejhospitals.com/article/detail/fall-risk-assessment) for the fall risk assessment. For prediction of fall-related injury risk, please goto [this link](https://3.106.58.71:8501).")
            else:
